...
class Brain {
        ...
        return new Promise((resolve, reject) => {
            ...
            c.createDevice(['gigabot', rando], false, (err, result) => {
                if (err) {
                    ...
                    fs.writeFile(this.getConfigFile(), JSON.stringify(this.config), (err) => {
                        if (err) {
                            reject(err);
                        }
                        else {
    ...
    getConfigFile() {
        let configFile = 'gigabot.config.json';
    ...
    readConfig() {
        ...
        return new Promise((resolve, reject) => {
            fs.exists(this.getConfigFile(), (exists) => {
                if (exists) {
                    fs.readFile(this.getConfigFile(), (err, data) => {
                        if (err) {
                            reject(err);
                        }
                        else {

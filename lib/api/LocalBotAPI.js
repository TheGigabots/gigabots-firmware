...
class Drive {
    ...
    raw(left, right) {
        ...
        let normalizedLeft = Math.abs(left);
        let normalizedRight = Math.abs(right);
        ...
        this.leftDrive.start(normalizedLeft);
        this.rightDrive.start(normalizedRight);
    }
